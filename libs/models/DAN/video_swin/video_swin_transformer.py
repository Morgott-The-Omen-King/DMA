...
from libs.models.DAN.video_swin.pe import build_position_encoding
...
if __name__ == '__main__':
    ...
    model = VideoSwinTransformerBackbone(True, '/home/knying/yingkaining/project/few-shot-vos/baselines/DANet/pretrain_model/swin_tiny_patch244_window877_kinetics400_1k.pth', True, **cfgs).cuda()
    inputs = torch.randn(10, 3, 241, 425).cuda() # 10 = 2 x 5
    # outs
    # 0: (10, 96, 96, 56)    96 1/4
    # 1: (10, 192, 48, 28)   192 1/8
    # 2: (10, 384, 24, 14)   384 1/16
    # 3: (10, 768, 12, 7)    768 1/32
